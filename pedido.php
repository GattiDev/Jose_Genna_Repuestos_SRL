...
<html lang="en">
    <head>
        ...
        <title>Jose Genna Repuestos : : Pedido</title>
        <!--/ Icono /-->
        <?php
		    $fecha = date("j-m");
    ...
    <body>
        ...
        <div class="container text-center">
            ...
            <div id="thingBisBody" class="row">
                ...
                <h2 class="efecto">Realice tu Pedido aquí</h2>                           

                <p>Deberás indicar el <i><b>“Código”</i></b> en caso que lo sepas, 
                    la <i><b>“Descripción”</i></b> del producto, 
                    las <i><b>“Cantidades”</i></b> que necesitas y 
                    por último el medio de trasporte; <i><b>“Comisionista/Micro”</i></b> o <i><b>“Retiro Personalmente”</i></b>.</p>							
                <p>Una vez que recibamos el pedido, le confirmaremos por correo electrónico si contamos con los productos solicitados. </p>   
                                
                <form action="controllers/send_pedido.php" method="post" class="form_contact">
                    <div class="formulario">
                        ...
                        <!--Transporte-->
                        <label for='transporte'>Transporte <span>*</span></label><br/>
                        <input class='transporte' type='text' name='transporte'><br/>
                
                        <!--Mesaje-->                          
                        <div class='textarea-msj'>               
                            <textarea class='mesaje' name='mesaje' required='required' placeholder='Deje tu pedido aquí. . .'></textarea><br/>
                        </div>
