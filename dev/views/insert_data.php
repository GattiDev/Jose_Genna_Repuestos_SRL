	    ...
	    <div class="modal-content">
			...
			<div class="modal-body">
				<form id="frm_setting">
                    ...
                    <input type="text" class="form-control" disabled id="licenseD" name="licenseD"></br>
                    <input type="text" hidden = "" class="form-control" id="licenseH" name="licenseH"></br>                     	
                		...
                		<?php
							...
							$data_setting = $obj_model->Run_setting();
                      		...
                      		while($get_setting = mysqli_fetch_assoc($data_setting)){ 
								...
								if($get_setting['user'] != 'GattiDev'){ ?>  
									
									<option  value="<?php echo $get_setting['id']; ?>"> <?php echo $get_setting['user']; ?></option>                      				
